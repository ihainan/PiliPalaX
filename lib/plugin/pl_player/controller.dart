...
class PlPlayerController extends GetxController {
  ...
  /// 显示跳过提示条
  void showSkipPrompt(ProgressBarRegion region) {
    if (isSliderMoving.value) return; // 如果用户正在拖动进度条，不要显示提示
    ...
    // 执行跳过
    seekTo(region.end, type: '${region.type}_skip');
  }
